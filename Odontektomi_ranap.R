...
data18 <- read_csv("Sheet 1_Full Data gresik 2018.csv") %>%
  ...
  select(-Nmtkp,-Kddiagprimer,-Nmdiagprimer)
...
data <- rbind(data18,data19,data20,data21,data22,data23,data24,
              dataapr24,datamei24)
rm(data18,data19,data20,data21,data22,data23,data24,dataapr24,
   datamei24)
...
data <- data %>%select(Nokapst,Nosjp,Jkpst,Umur,Nmdati2Layan,Nmppklayan,
                       Tglpelayanan,Tgldtgsjp,Tglplgsjp,Kdinacbgs,
                       Nminacbgs,Diagprimer,Diagsekunder,Procedure,
                       Namadpjp,Nmjnspulang,biayars,Biayaverifikasi)
