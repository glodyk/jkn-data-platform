...
lowbp <- data %>%
  ...
  filter(str_detect(Diagnosis,"M545|M179|M1999|arthrosis|Arthrosis")) %>%
...
library(splitstackshape)
lowbp1 <- concat.split(lowbp, "Diagnosa", ";")
colnames(lowbp1)
...
lowbp1$Diagakhir <- as.character(trimws(gsub(";NA;NA;NA;NA;NA;NA;NA;NA;NA;NA|;NA;NA;NA;NA;NA;NA;NA;NA;NA|;NA;NA;NA;NA;NA;NA;NA;NA|;NA;NA;NA;NA;NA;NA;NA|;NA;NA;NA;NA;NA;NA|;NA;NA;NA;NA;NA|;NA;NA;NA;NA|;NA;NA;NA|;NA;NA|;NA|NA;","",lowbp1$Diagakhir)),"both")
lowbp1 <- lowbp1 %>%
  select(-Diagnosa_1,-Diagnosa_2,-Diagnosa_3,-Diagnosa_4,-Diagnosa_5,
         -Diagnosa_6,-Diagnosa_7,-Diagnosa_8,-Diagnosa_9,-Diagnosa_010,-Diagnosa)
...
lowbp1$Procedure_new <- as.character(trimws(gsub("NA;NA;NA;NA;NA;NA;NA||;NA;NA;NA;NA;NA;NA|;NA;NA;NA;NA;NA|;NA;NA;NA;NA|;NA;NA;NA|;NA;NA|;NA|NA",
                                                   "",lowbp1$Procedure_new)),"both")
lowbp1 <- lowbp1 %>%
  select(-Procedure_1,-Procedure_2,-Procedure_3,-Procedure_4,-Procedure_5,-Procedure_6,-Procedure_7)
