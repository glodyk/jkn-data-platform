...
data19 <- read_csv("Sheet 1_Full Data gresik 2019.csv") %>%
  select (Nokapst,Nosjp,Jkpst,Umur,Nmtkp,Kdppklayan,Nmdati2Layan,Politujsjp,
...
data <- data %>%
  select (Nokapst,Nosjp,Jkpst,Umur,Nmtkp,Nmppklayan,Nmdati2Layan,Politujsjp,
          Tglpelayanan,Tgldtgsjp,Tglplgsjp,Kdinacbgs,Nminacbgs,Kddiagprimer,
          Nmdiagprimer,Diagsekunder,Procedure,Namadpjp,Nmjnspulang,
          biayars,Biayaverifikasi)

write.csv(data, "D://data gresik//MTF KC GRESIK//gresik_2020//irm_stroke.csv",
          na="", row.names = FALSE)
#==================================================================
