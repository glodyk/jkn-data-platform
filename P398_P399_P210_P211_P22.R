...
data20 <- read_csv("Sheet 1_Full Data gresik 2020.csv") %>%
  select (Nokapst,Kelashak,Nosjp,Jkpst,Umur,Nmtkp,Kdppklayan,
          ...
          Nminacbgs,kdsd,kdsi,kdsp,kdsr,Kdcmg,Kddiagprimer,
          Nmdiagprimer,Diagsekunder,Procedure,Namadpjp,
          Nmjnspulang,Tarifgroup,biayars,Biayaverifikasi) %>%
  subset(Kdcmg == "P") %>%
  filter(str_detect(Kddiagprimer,c("P398|P399|P210|P211|P22")))
...
data <- rbind(data20,data21,data22,data23,data24)
rm(data20,data21,data22,data23,data24)
