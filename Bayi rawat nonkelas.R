...
data15 <- read_csv("Sheet 1_Full Data gresik 2015.csv") %>%
  select (Nokapst,Nosjp,Jkpst,Umur,Nmdati2Layan,Kdppklayan,Nmtkp,
          ...
          Nmjnspulang,Klsrawat,Biayaverifikasi) %>%
  subset(Nmtkp == "RITL") %>%
  subset(Klsrawat == "Kelas I" | Klsrawat == "Kelas II") %>%
  mutate(Diagnosa = paste0(as.character(Kddiagprimer)," - ",
                           as.character(Nmdiagprimer),";",
                           as.character(Diagsekunder))) %>%
  filter(str_detect(Diagnosa,c("P000|P002|P012|P015|P028|P031|P032|P034|P036|P050|P051|P052|P059|P070|P071|P072|P073|P080|P081|P082|P113|P120|P128|P129|P132|P134|P138|P140|P152|P154|P158|P159|P201|P209|P210|P211|P219|P220|P221|P228|P229|P230|P236|P238|P239|P240|P241|P242|P243|P248|P249|P271|P278|P279|P282|P284|P285|P288|P289|P290|P291|P293|P298|P299|P353|P358|P359|P360|P361|P365|P368|P369|P370|P375|P378|P379|P38|P390|P391|P392|P393|P394|P398|P399|P509|P518|P519|P520|P523|P53|P540|P541|P543|P545|P546|P548|P549|P551|P559|P578|P579|P580|P581|P582|P583|P585|P588|P589|P590|P592|P593|P598|P599|P610|P611|P612|P614|P616|P700|P701|P702|P703|P704|P708|P709|P710|P714|P719|P721|P722|P741|P743|P744|P748|P760|P761|P768|P769|P77|P780|P782|P783|P788|P789|P808|P809|P810|P818|P819|P831|P833|P835|P838|P839|P90|P916|P920|P922|P923|P925|P928|P929|P95|P960|P968|P969"))) %>%
  select(-Diagnosa)
...
bayinonkelassjp <- bayinonkelas %>% select(Nosjp)
bayinonkelassjp$Keterangan <- "audit anomali 7"

data2 <- left_join(data1,bayinonkelassjp, by = c("Nosjp"="Nosjp"))
data2 <- data2[order(data2$Tglplgsjp),]
...
data2 <- data2 %>%
  select(Nokapst,Nosjp,Jkpst,Umur,Nmdati2Layan,Nmppklayan,Nmtkp,
         ...
         Nmdiagprimer,Diagsekunder,Procedure,Namadpjp,Nmjnspulang,Klsrawat,
         Biayaverifikasi,Keterangan)

write.xlsx(data3, file = "Kraniotomi pada kasus hydocephalus.xlsx")
