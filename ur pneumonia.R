...
data16 <- read_csv("Sheet 1_Full Data gresik 2016.csv") %>%
  ...
  filter(str_detect(Diagnosa,c("Pneumonia|pneumonia"))) %>%
  filter(!str_detect(Diagnosa,c("Bronchopneumonia|bronchopneumonia"))) %>%
  select(-Diagnosa)
...
#========================================================================
write.xlsx(data1, file = "pneumonia_auditmedis.xlsx")
#========================================================================
