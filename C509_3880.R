...
data16 <- read_csv("Sheet 1_Full Data gresik 2016.csv") %>%
  ...
  subset(Kddiagprimer == "D180") %>%
  filter(str_detect(Procedure,c("3886")))
...
data$Seharusnya <- "8541 - Unilateral simple mastectomy"
...
write.xlsx(data, file = "C509_3880 menjadi 8541.xlsx")
