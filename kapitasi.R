...
#=============================data nadyah=============================
kapitasi <- read_csv("Sheet 1_Full Data_kapitasi.csv") %>%
  select(jmlpstkap,susulan_jmlpstkap,susulan_jmlpstkap_asal,jnspstreg,
         kapbpj,susulan_kapbpj,susulan_kapbpj_asal,tglpelayanan,
         nmdati2,nmjnsppk,nmtypeppk,nmppk,normakapitasi,jml_dokter,
         jml_dokter_gigi,tglstjkeu,tanggalbayar,bykapitasi,
         susulan_bykapitasi,susulan_bykapitasi_asal,usia_0_5_laki,
         usia_0_5_perempuan,usia_21_60_laki,usia_21_60_perempuan,
         usia_6_20_laki,usia_6_20_perempuan,usia_atas60_laki,
         usia_atas60_perempuan,susulan_usia_0_5_laki,
         susulan_usia_0_5_perempuan,susulan_usia_21_60_laki,
         susulan_usia_21_60_perempuan,susulan_usia_6_20_laki,
         susulan_usia_6_20_perempuan,susulan_usia_atas60_laki,
         susulan_usia_atas60_perempuan)
...
kapitasi$susulan_jmlpstkap [is.na(kapitasi$susulan_jmlpstkap)] <- 0
kapitasi$susulan_jmlpstkap <- as.numeric(kapitasi$susulan_jmlpstkap)
kapitasi$susulan_jmlpstkap_asal [is.na(kapitasi$susulan_jmlpstkap_asal)] <- 0
kapitasi$susulan_jmlpstkap_asal <- as.numeric(kapitasi$susulan_jmlpstkap_asal)
kapitasi$susulan_kapbpj [is.na(kapitasi$susulan_kapbpj)] <- 0
kapitasi$susulan_kapbpj <- as.numeric(kapitasi$susulan_kapbpj)
kapitasi$susulan_kapbpj_asal [is.na(kapitasi$susulan_kapbpj_asal)] <- 0
kapitasi$susulan_kapbpj_asal <- as.numeric(kapitasi$susulan_kapbpj_asal)
kapitasi$normakapitasi [is.na(kapitasi$normakapitasi)] <- 0
kapitasi$normakapitasi <- as.numeric(kapitasi$normakapitasi)
kapitasi$jml_dokter [is.na(kapitasi$jml_dokter)] <- 0
kapitasi$jml_dokter <- as.numeric(kapitasi$jml_dokter)
kapitasi$jml_dokter_gigi [is.na(kapitasi$jml_dokter_gigi)] <- 0
kapitasi$jml_dokter_gigi <- as.numeric(kapitasi$jml_dokter_gigi)
kapitasi$susulan_bykapitasi [is.na(kapitasi$susulan_bykapitasi)] <- 0
kapitasi$susulan_bykapitasi <- as.numeric(kapitasi$susulan_bykapitasi)
kapitasi$susulan_bykapitasi_asal [is.na(kapitasi$susulan_bykapitasi_asal)] <- 0
kapitasi$susulan_bykapitasi_asal <- as.numeric(kapitasi$susulan_bykapitasi_asal)
kapitasi$usia_0_5_laki [is.na(kapitasi$usia_0_5_laki)] <- 0
kapitasi$usia_0_5_laki <- as.numeric(kapitasi$usia_0_5_laki)
kapitasi$usia_0_5_perempuan [is.na(kapitasi$usia_0_5_perempuan)] <- 0
kapitasi$usia_0_5_perempuan <- as.numeric(kapitasi$usia_0_5_perempuan)
kapitasi$usia_21_60_laki [is.na(kapitasi$usia_21_60_laki)] <- 0
kapitasi$usia_21_60_laki <- as.numeric(kapitasi$usia_21_60_laki)
kapitasi$usia_21_60_perempuan [is.na(kapitasi$usia_21_60_perempuan)] <- 0
kapitasi$usia_21_60_perempuan <- as.numeric(kapitasi$usia_21_60_perempuan)
kapitasi$usia_6_20_laki [is.na(kapitasi$usia_6_20_laki)] <- 0
kapitasi$usia_6_20_laki <- as.numeric(kapitasi$usia_6_20_laki)
kapitasi$usia_6_20_perempuan [is.na(kapitasi$usia_6_20_perempuan)] <- 0
kapitasi$usia_6_20_perempuan <- as.numeric(kapitasi$usia_6_20_perempuan)
kapitasi$usia_atas60_laki [is.na(kapitasi$usia_atas60_laki)] <- 0
kapitasi$usia_atas60_laki <- as.numeric(kapitasi$usia_atas60_laki)
kapitasi$usia_atas60_perempuan [is.na(kapitasi$usia_atas60_perempuan)] <- 0
kapitasi$usia_atas60_perempuan <- as.numeric(kapitasi$usia_atas60_perempuan)
kapitasi$susulan_usia_0_5_laki [is.na(kapitasi$susulan_usia_0_5_laki)] <- 0
kapitasi$susulan_usia_0_5_laki <- as.numeric(kapitasi$susulan_usia_0_5_laki)
kapitasi$susulan_usia_0_5_perempuan [is.na(kapitasi$susulan_usia_0_5_perempuan)] <- 0
kapitasi$susulan_usia_0_5_perempuan <- as.numeric(kapitasi$susulan_usia_0_5_perempuan)
kapitasi$susulan_usia_21_60_laki [is.na(kapitasi$susulan_usia_21_60_laki)] <- 0
kapitasi$susulan_usia_21_60_laki <- as.numeric(kapitasi$susulan_usia_21_60_laki)
kapitasi$susulan_usia_21_60_perempuan [is.na(kapitasi$susulan_usia_21_60_perempuan)] <- 0
kapitasi$susulan_usia_21_60_perempuan <- as.numeric(kapitasi$susulan_usia_21_60_perempuan)
kapitasi$susulan_usia_6_20_laki [is.na(kapitasi$susulan_usia_6_20_laki)] <- 0
kapitasi$susulan_usia_6_20_laki <- as.numeric(kapitasi$susulan_usia_6_20_laki)
kapitasi$susulan_usia_6_20_perempuan [is.na(kapitasi$susulan_usia_6_20_perempuan)] <- 0
kapitasi$susulan_usia_6_20_perempuan <- as.numeric(kapitasi$susulan_usia_6_20_perempuan)
kapitasi$susulan_usia_atas60_laki [is.na(kapitasi$susulan_usia_atas60_laki)] <- 0
kapitasi$usia_atas60_perempuan <- as.numeric(kapitasi$usia_atas60_perempuan)
kapitasi$susulan_usia_atas60_perempuan [is.na(kapitasi$susulan_usia_atas60_perempuan)] <- 0
kapitasi$usia_atas60_perempuan <- as.numeric(kapitasi$usia_atas60_perempuan)

kapitasi <- kapitasi %>%
  subset(tglpelayanan >= "2019-01-01")
...
#==============================================================================
write.csv(kapitasi, "D://data gresik//MTF KC GRESIK//gresik_2020//kapitasi.csv",
          na="", row.names = FALSE)
#==============================================================================
...
kapitasi <- read_csv("Sheet 1_Full Data_kapitasi.csv") %>%
  select(bpjkoreksi,bykapitasi,jeniskoreksi,jml_dokter,jml_dokter_gigi,
         jmlpstkap,jmlpstkoreksi,jnspstreg,kapbpj,kapflagkeu,kapflagpst,
         kategorifktp,kdppk,konskbk,koreksike,nmdati2,nmjnsppk,nmppk,
         nmtypeppk,nofpk,noreg,noregkoreksi,normakapitasi,rasiodokter,
         susulan_bykapitasi,susulan_bykapitasi_asal,susulan_jeniskoreksi,
         susulan_jmlpstkap,susulan_jmlpstkap_asal,susulan_kapbpj,
         susulan_kapbpj_asal,susulan_kategorifktp,susulan_koreksike,
         susulan_usia_0_5_laki,susulan_usia_0_5_perempuan,
         susulan_usia_21_60_laki,susulan_usia_21_60_perempuan,
         susulan_usia_6_20_laki,susulan_usia_6_20_perempuan,
         susulan_usia_atas60_laki,susulan_usia_atas60_perempuan,
         tanggalbayar,tglkoreksi,tglpelayanan,tglstjkeu,usia_0_5_laki,
         usia_0_5_perempuan,usia_21_60_laki,usia_21_60_perempuan,
         usia_6_20_laki,usia_6_20_perempuan,usia_atas60_laki,
         usia_atas60_perempuan)



%>%
  select (nokapst,nmpst,jkpst,umur,pstprb,pstprolanis,katastropik,
          nmdati2layan,nmdati2resep,kdppklayan,nmjnsppkresep,
          nmppklayan,refasalsjp,nosjp_apotek,kdppkresep,
          nmppkresep,nmtkp,politujsjp,tglpelayanan,tglrsp,tglsjp,
          jenisobat,kdobat,obat,generik,dagang,noresep,jmlobt,
          sediaan,flag_iterasi,jenis_obat_luarpaket,obatluarpaket,
          kdinacbgs,kd_diagprimer,nm_diagprimer,diagsekunder,nmdokter,
          biaya,tglstjkeu) %>%
  subset(pstprb == "TRUE") %>%
  subset(nmtkp == "RJTL")

obat1819 <- read_csv("Sheet_1_Full_Data_data obat 18_19.csv") %>%
  select (nokapst,nmpst,jkpst,umur,pstprb,pstprolanis,katastropik,
          nmdati2layan,nmdati2resep,kdppklayan,nmjnsppkresep,
          nmppklayan,refasalsjp,nosjp_apotek,kdppkresep,
          nmppkresep,nmtkp,politujsjp,tglpelayanan,tglrsp,tglsjp,
...
obat24 <- read_csv("Sheet_1_Full_Data_data obat 24.csv") %>%
  select (nokapst,nmpst,jkpst,umur,pstprb,pstprolanis,katastropik,
          nmdati2layan,nmdati2resep,kdppklayan,nmjnsppkresep,
          nmppklayan,refasalsjp,nosjp_apotek,kdppkresep,
          nmppkresep,nmtkp,politujsjp,tglpelayanan,tglrsp,tglsjp,
...
data <- rbind(obat1417,obat1819,obat2223,obat24)
rm(obat1417,obat1819,obat2223,obat24)
...
#==============================================================================
write.csv(data, "D://data gresik//MTF KC GRESIK//obat//ur_obat.csv",
          na="", row.names = FALSE)
#==============================================================================
