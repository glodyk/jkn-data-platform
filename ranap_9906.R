...
df_jan19 <- read_csv("Sheet_1_Full_Data_data gresik jan 19.csv") %>%
  select (Nokapst,Nosjp,Jkpst,Nmtkp,Nmppklayan,Tgldtgsjp,Tglplgsjp,
          ...
          Procedure,Namadpjp,Nmjnspulang,Biayaverifikasi) %>%
  subset(Nmtkp == "RITL") %>%
  subset(Procedure == "9906 - Transfusion of coagulation factors")
...
write.xlsx(data, file = "Transfusion of coagulation factors.xlsx")
