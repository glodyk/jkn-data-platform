...
nonspes$Diagnosa_14 <- as.character(trimws(nonspes$Diagnosa_14))
nonspes$Diagnosa_15 <- as.character(trimws(nonspes$Diagnosa_15))
nonspes$Diagnosa_16 <- as.character(trimws(nonspes$Diagnosa_16))
...
nonspes$Diagnosa_14 <- with(nonspes,ifelse(is.na(nonspes$Diagnosa_14),NA,Diagnosa_14))
nonspes$Diagnosa_15 <- with(nonspes,ifelse(is.na(nonspes$Diagnosa_15),NA,Diagnosa_15))
nonspes$Diagnosa_16 <- with(nonspes,ifelse(is.na(nonspes$Diagnosa_16),NA,Diagnosa_16))
...
nonspes$Diagnosa <- as.character(trimws(gsub("NA;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA|;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA|;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA|;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA|;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA|;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA|;NA;NA;NA;NA;NA;NA;NA;NA;NA;NA|;NA;NA;NA;NA;NA;NA;NA;NA;NA|;NA;NA;NA;NA;NA;NA;NA;NA|;NA;NA;NA;NA;NA;NA;NA|;NA;NA;NA;NA;NA;NA|;NA;NA;NA;NA;NA|;NA;NA;NA;NA|;NA;NA;NA|;NA;NA|;NA|NA;|NA","",nonspes$Diagnosa)),"both")
nonspes <- nonspes %>%
  select(-Diagnosa_01,-Diagnosa_02,-Diagnosa_03,-Diagnosa_04,-Diagnosa_05,
         ...
         -Diagnosa_11,-Diagnosa_12,-Diagnosa_13,-Diagnosa_14,,-Diagnosa_15,
         -Diagnosa_16)
nonspes <- nonspes %>% mutate(Diagnosa = na_if(Diagnosa, ""))
nonspes1 <- nonspes %>% subset(is.na(Diagnosa))

nonspes <- nonspes[order(nonspes$Nokapst,nonspes$Tglplgsjp),]
nonspes$Keterangan <- "Serangan Stroke"
...
#======================================================================================
write.csv(nonspes, "D://data gresik//MTF KC GRESIK//gresik_2020//ur_G_4_14.csv",
          na="", row.names = FALSE)
