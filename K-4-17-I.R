...
data <- data %>%
  subset(Tglplgsjp >= "2018-01-01" & Tglplgsjp <= "2024-02-29")

data$LOS <- as.integer(data$Tglplgsjp) - as.integer(data$Tgldtgsjp) +1
data <- data %>% subset(LOS <= 2)
data <- data[order(data$Tglplgsjp),]
#========================================================================
write.xlsx(data, file = "K-4-17-I.xlsx")
#========================================================================
