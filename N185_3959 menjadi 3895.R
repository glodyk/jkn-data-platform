...
data16 <- read_csv("Sheet 1_Full Data gresik 2016.csv") %>%
  ...
  subset(Kddiagprimer == "N185") %>%
  filter(str_detect(Procedure,c("3959")))
...
data$Seharusnya <- "3895 - Venous catheterization for renal dialysis"
...
write.xlsx(data, file = "N185_3959 menjadi 3859.xlsx")
