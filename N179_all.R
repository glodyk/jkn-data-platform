...
data21 <- read_csv("Sheet 1_Full Data gresik 2021.csv") %>%
  ...
  filter(str_detect(Diagnosa,c("N179"))) %>%
  select(-Diagnosa)
...
data <- rbind(data21,data22,data23,data24,data24apr)
rm(data21,data22,data23,data24,data24apr)
...
data <- data %>% subset(Tglplgsjp >= "2021-01-01")
...
#========================================================================
write.xlsx(data, file = "ur_N179_all.xlsx")
#========================================================================
