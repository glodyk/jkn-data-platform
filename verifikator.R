...
data19 <- read_csv("Sheet 1_Full Data gresik 2019.csv") %>%
  select (Nosjp,Nmtkp,Kdppklayan,Nmdati2Layan,
          Tglpelayanan,Biayaverifikasi)
...
data <- data %>% 
  mutate(
    verifikator = case_when(
      Kdppklayan == "1302R001" ~ "kimi",
      Kdppklayan == "1306R001" ~ "miftah",
      Kdppklayan == "0204R010" ~ "tuti",
      Kdppklayan == "0204R003" ~ "rodiyah",
      Kdppklayan == "0205R012" ~ "lingga",
      Kdppklayan == "1302R002" ~ "mitri",
      Kdppklayan == "0204R009" ~ "hemilda",
      Kdppklayan == "0204R013" ~ "tuti",
      Kdppklayan == "0205R021" ~ "fithriyah",
      Kdppklayan == "0205R011" ~ "musyaadah",
      Kdppklayan == "0205R013" ~ "dian panorama",
      Kdppklayan == "0205R014" ~ "mutiara",
      Kdppklayan == "0205R009" ~ "shofie",
      Kdppklayan == "0205R019" ~ "mutiara",
      Kdppklayan == "0205R022" ~ "fithriyah",
      Kdppklayan == "0205R024" ~ "shofie",
      Kdppklayan == "0205R023" ~ "mutiara",
      Kdppklayan == "0204R012" ~ "rodiyah",
      Kdppklayan == "0204R004" ~ "dian panorama",
      Kdppklayan == "0205R025" ~ "mitri",
      Kdppklayan == "0205S100" ~ "musyaadah",
      Kdppklayan == "0204S001" ~ "shofie",
      Kdppklayan == "0204R014" ~ "lingga",
      Kdppklayan == "0205R026" ~ "shofie",
      Kdppklayan == "0205R027" ~ "dian panorama",
      Kdppklayan == "0205R028" ~ "kimi",
      Kdppklayan == "0204R015" ~ "miftah",
      Kdppklayan == "0205R029" ~ "lingga",
      Kdppklayan == "0204R017" ~ "musyaadah",
      Kdppklayan == "0204R018" ~ "mitri",
      Kdppklayan == "0205R031" ~ "fithriyah",
      Kdppklayan == "0204R019" ~ "rodiyah",
      Kdppklayan == "0205R030" ~ "musyaadah",
      Kdppklayan == "0204R020" ~ "tuti",
      Kdppklayan == "0204R021" ~ "hemilda",
      Kdppklayan == "0204R023" ~ "hemilda",
      Kdppklayan == "0204R022" ~ "rodiyah",
      Kdppklayan == "0204R024" ~ "dian panorama",
      Kdppklayan == "0205R032" ~ "fithriyah",
      Kdppklayan == "0205S101" ~ "kimi",
      TRUE ~ Kdppklayan))
#========================================================================

data <- data %>% select(-Kdppklayan)
...
#========================================================================
write.csv(data, "D://data gresik//MTF KC GRESIK/gresik_2020//verifikator2.csv",
          na="", row.names = FALSE)

write.xlsx(data, file = "verifikator.xlsx")
#========================================================================
