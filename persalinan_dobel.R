...
data14 <- read_csv("Sheet 1_Full Data gresik 2014.csv") %>%
  select (Nokapst,Nosjp,Jkpst,Umur,Nmtkp,Nmdati2Layan,Nmppklayan,
          Klsrawat,Tgldtgsjp,Tglplgsjp,Kdinacbgs,Kddiagprimer,
          Nmdiagprimer,Diagsekunder,Procedure,Nmjnspulang,biayars,
          Biayaverifikasi) %>% 
  subset(Nmtkp == "RITL") %>%
...
data <- rbind(data14,data15,data16,data17,data18,
              data19,data20,data21,data22,data23,
              df_jan24,df_feb24,df_mar24)

rm(data14,data15,data16,data17,data18,
   data19,data20,data21,data22,data23,
   df_jan24,df_feb24,df_mar24)
...
data <- data %>%
  subset(Tglplgsjp >= "2016-01-01" & Tglplgsjp <= "2024-02-29")
#========================================================================
