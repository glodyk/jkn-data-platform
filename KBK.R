setwd("D:/data gresik/FactKunjungan/KBK")
...
#=============================data nadyah=============================
kbkdes22 <- read.csv2("kbk_des22.csv") %>%
  select(Dati2,Kode.PPK,Faskes,Angka.Kontak,Jumlah.Kontak,Jumlah.Rujukan,
         Kasus.Non.Spesialistik,Peserta.Diangnosa.DM,Peserta.Diangnosa.HT,
         Peserta.Terdaftar,Prolanis.DM.Terkendali,Prolanis.HT.Terkendali,
         RPPT.DM,RPPT.HT,RPPT) %>%
  mutate(`Bulan KBK` = "12/1/2022")

kbkjan23 <- read.csv2("kbk_jan23.csv") %>%
  select(Dati2,Kode.PPK,Faskes,Angka.Kontak,Jumlah.Kontak,Jumlah.Rujukan,
         Kasus.Non.Spesialistik,Peserta.Diangnosa.DM,Peserta.Diangnosa.HT,
         Peserta.Terdaftar,Prolanis.DM.Terkendali,Prolanis.HT.Terkendali,
         RPPT.DM,RPPT.HT,RPPT) %>%
  mutate(`Bulan KBK` = "1/1/2023")

kbkfeb23 <- read.csv2("kbk_feb23.csv") %>%
  select(Dati2,Kode.PPK,Faskes,Angka.Kontak,Jumlah.Kontak,Jumlah.Rujukan,
         Kasus.Non.Spesialistik,Peserta.Diangnosa.DM,Peserta.Diangnosa.HT,
         Peserta.Terdaftar,Prolanis.DM.Terkendali,Prolanis.HT.Terkendali,
         RPPT.DM,RPPT.HT,RPPT) %>%
  mutate(`Bulan KBK` = "2/1/2023")

kbkmar23 <- read.csv2("kbk_mar23.csv") %>%
  select(Dati2,Kode.PPK,Faskes,Angka.Kontak,Jumlah.Kontak,Jumlah.Rujukan,
         Kasus.Non.Spesialistik,Peserta.Diangnosa.DM,Peserta.Diangnosa.HT,
         Peserta.Terdaftar,Prolanis.DM.Terkendali,Prolanis.HT.Terkendali,
         RPPT.DM,RPPT.HT,RPPT) %>%
  mutate(`Bulan KBK` = "3/1/2023")

kbkapr23 <- read.csv2("kbk_apr23.csv") %>%
  select(Dati2,Kode.PPK,Faskes,Angka.Kontak,Jumlah.Kontak,Jumlah.Rujukan,
         Kasus.Non.Spesialistik,Peserta.Diangnosa.DM,Peserta.Diangnosa.HT,
         Peserta.Terdaftar,Prolanis.DM.Terkendali,Prolanis.HT.Terkendali,
         RPPT.DM,RPPT.HT,RPPT) %>%
  mutate(`Bulan KBK` = "4/1/2023")

kbkmei23 <- read.csv2("kbk_mei23.csv") %>%
  select(Dati2,Kode.PPK,Faskes,Angka.Kontak,Jumlah.Kontak,Jumlah.Rujukan,
         Kasus.Non.Spesialistik,Peserta.Diangnosa.DM,Peserta.Diangnosa.HT,
         Peserta.Terdaftar,Prolanis.DM.Terkendali,Prolanis.HT.Terkendali,
         RPPT.DM,RPPT.HT,RPPT) %>%
  mutate(`Bulan KBK` = "5/1/2023")

kbkjun23 <- read.csv2("kbk_jun23.csv") %>%
  select(Dati2,Kode.PPK,Faskes,Angka.Kontak,Jumlah.Kontak,Jumlah.Rujukan,
         Kasus.Non.Spesialistik,Peserta.Diangnosa.DM,Peserta.Diangnosa.HT,
         Peserta.Terdaftar,Prolanis.DM.Terkendali,Prolanis.HT.Terkendali,
         RPPT.DM,RPPT.HT,RPPT) %>%
  mutate(`Bulan KBK` = "6/1/2023")

kbkjul23 <- read.csv2("kbk_jul23.csv") %>%
  select(Dati2,Kode.PPK,Faskes,Angka.Kontak,Jumlah.Kontak,Jumlah.Rujukan,
         Kasus.Non.Spesialistik,Peserta.Diangnosa.DM,Peserta.Diangnosa.HT,
         Peserta.Terdaftar,Prolanis.DM.Terkendali,Prolanis.HT.Terkendali,
         RPPT.DM,RPPT.HT,RPPT) %>%
  mutate(`Bulan KBK` = "7/1/2023")

kbkagu23 <- read.csv2("kbk_agu23.csv") %>%
  select(Dati2,Kode.PPK,Faskes,Angka.Kontak,Jumlah.Kontak,Jumlah.Rujukan,
         Kasus.Non.Spesialistik,Peserta.Diangnosa.DM,Peserta.Diangnosa.HT,
         Peserta.Terdaftar,Prolanis.DM.Terkendali,Prolanis.HT.Terkendali,
         RPPT.DM,RPPT.HT,RPPT) %>%
  mutate(`Bulan KBK` = "8/1/2023")

kbksep23 <- read.csv2("kbk_sep23.csv") %>%
  select(Dati2,Kode.PPK,Faskes,Angka.Kontak,Jumlah.Kontak,Jumlah.Rujukan,
         Kasus.Non.Spesialistik,Peserta.Diangnosa.DM,Peserta.Diangnosa.HT,
         Peserta.Terdaftar,Prolanis.DM.Terkendali,Prolanis.HT.Terkendali,
         RPPT.DM,RPPT.HT,RPPT) %>%
  mutate(`Bulan KBK` = "9/1/2023")

kbkokt23 <- read.csv2("kbk_okt23.csv") %>%
  select(Dati2,Kode.PPK,Faskes,Angka.Kontak,Jumlah.Kontak,Jumlah.Rujukan,
         Kasus.Non.Spesialistik,Peserta.Diangnosa.DM,Peserta.Diangnosa.HT,
         Peserta.Terdaftar,Prolanis.DM.Terkendali,Prolanis.HT.Terkendali,
         RPPT.DM,RPPT.HT,RPPT) %>%
  mutate(`Bulan KBK` = "10/1/2023")

kbknov23 <- read.csv2("kbk_nov23.csv") %>%
  select(Dati2,Kode.PPK,Faskes,Angka.Kontak,Jumlah.Kontak,Jumlah.Rujukan,
         Kasus.Non.Spesialistik,Peserta.Diangnosa.DM,Peserta.Diangnosa.HT,
         Peserta.Terdaftar,Prolanis.DM.Terkendali,Prolanis.HT.Terkendali,
         RPPT.DM,RPPT.HT,RPPT) %>%
  mutate(`Bulan KBK` = "11/1/2023")

kbkdes23 <- read.csv2("kbk_des23.csv") %>%
  select(Dati2,Kode.PPK,Faskes,Angka.Kontak,Jumlah.Kontak,Jumlah.Rujukan,
         Kasus.Non.Spesialistik,Peserta.Diangnosa.DM,Peserta.Diangnosa.HT,
         Peserta.Terdaftar,Prolanis.DM.Terkendali,Prolanis.HT.Terkendali,
         RPPT.DM,RPPT.HT,RPPT) %>%
  mutate(`Bulan KBK` = "12/1/2023")

kbkjan24 <- read.csv2("kbk_jan24.csv") %>%
  select(Dati2,Kode.PPK,Faskes,Angka.Kontak,Jumlah.Kontak,Jumlah.Rujukan,
         Kasus.Non.Spesialistik,Peserta.Diangnosa.DM,Peserta.Diangnosa.HT,
         Peserta.Terdaftar,Prolanis.DM.Terkendali,Prolanis.HT.Terkendali,
         RPPT.DM,RPPT.HT,RPPT) %>%
  mutate(`Bulan KBK` = "1/1/2024")

kbkfeb24 <- read.csv2("kbk_feb24.csv") %>%
  select(Dati2,Kode.PPK,Faskes,Angka.Kontak,Jumlah.Kontak,Jumlah.Rujukan,
         Kasus.Non.Spesialistik,Peserta.Diangnosa.DM,Peserta.Diangnosa.HT,
         Peserta.Terdaftar,Prolanis.DM.Terkendali,Prolanis.HT.Terkendali,
         RPPT.DM,RPPT.HT,RPPT) %>%
  mutate(`Bulan KBK` = "2/1/2024")

kbkmar24 <- read.csv2("kbk_mar24.csv") %>%
  select(Dati2,Kode.PPK,Faskes,Angka.Kontak,Jumlah.Kontak,Jumlah.Rujukan,
         Kasus.Non.Spesialistik,Peserta.Diangnosa.DM,Peserta.Diangnosa.HT,
         Peserta.Terdaftar,Prolanis.DM.Terkendali,Prolanis.HT.Terkendali,
         RPPT.DM,RPPT.HT,RPPT) %>%
  mutate(`Bulan KBK` = "3/1/2024")

kbkapr24 <- read.csv2("kbk_apr24.csv") %>%
  select(Dati2,Kode.PPK,Faskes,Angka.Kontak,Jumlah.Kontak,Jumlah.Rujukan,
         Kasus.Non.Spesialistik,Peserta.Diangnosa.DM,Peserta.Diangnosa.HT,
         Peserta.Terdaftar,Prolanis.DM.Terkendali,Prolanis.HT.Terkendali,
         RPPT.DM,RPPT.HT,RPPT) %>%
  mutate(`Bulan KBK` = "4/1/2024")

kbkmei24 <- read.csv2("kbk_mei24.csv") %>%
  select(Dati2,Kode.PPK,Faskes,Angka.Kontak,Jumlah.Kontak,Jumlah.Rujukan,
         Kasus.Non.Spesialistik,Peserta.Diangnosa.DM,Peserta.Diangnosa.HT,
         Peserta.Terdaftar,Prolanis.DM.Terkendali,Prolanis.HT.Terkendali,
         RPPT.DM,RPPT.HT,RPPT) %>%
  mutate(`Bulan KBK` = "5/1/2024")

kbkjun24 <- read.csv2("kbk_jun24.csv") %>%
  select(Dati2,Kode.PPK,Faskes,Angka.Kontak,Jumlah.Kontak,Jumlah.Rujukan,
         Kasus.Non.Spesialistik,Peserta.Diangnosa.DM,Peserta.Diangnosa.HT,
         Peserta.Terdaftar,Prolanis.DM.Terkendali,Prolanis.HT.Terkendali,
         RPPT.DM,RPPT.HT,RPPT) %>%
  mutate(`Bulan KBK` = "6/1/2024")

kbkjul24 <- read.csv2("kbk_jul24.csv") %>%
  select(Dati2,Kode.PPK,Faskes,Angka.Kontak,Jumlah.Kontak,Jumlah.Rujukan,
         Kasus.Non.Spesialistik,Peserta.Diangnosa.DM,Peserta.Diangnosa.HT,
         Peserta.Terdaftar,Prolanis.DM.Terkendali,Prolanis.HT.Terkendali,
         RPPT.DM,RPPT.HT,RPPT) %>%
  mutate(`Bulan KBK` = "7/1/2024")

kbkagu24 <- read.csv2("kbk_agu24.csv") %>%
  select(Dati2,Kode.PPK,Faskes,Angka.Kontak,Jumlah.Kontak,Jumlah.Rujukan,
         Kasus.Non.Spesialistik,Peserta.Diangnosa.DM,Peserta.Diangnosa.HT,
         Peserta.Terdaftar,Prolanis.DM.Terkendali,Prolanis.HT.Terkendali,
         RPPT.DM,RPPT.HT,RPPT) %>%
  mutate(`Bulan KBK` = "8/1/2024")

data <- rbind(kbkdes22,kbkjan23,kbkfeb23,kbkmar23,kbkapr23,kbkmei23,kbkjun23,
              kbkjul23,kbkagu23,kbksep23,kbkokt23,kbknov23,kbkdes23,kbkjan24,
              kbkfeb24,kbkmar24,kbkapr24,kbkmei24,kbkjun24,kbkjul24,kbkagu24)
rm(kbkdes22,kbkjan23,kbkfeb23,kbkmar23,kbkapr23,kbkmei23,kbkjun23,
   kbkjul23,kbkagu23,kbksep23,kbkokt23,kbknov23,kbkdes23,kbkjan24,
   kbkfeb24,kbkmar24,kbkapr24,kbkmei24,kbkjun24,kbkjul24,kbkagu24)

data$`Bulan KBK` <- as.Date(data$`Bulan KBK`, format = "%m/%d/%Y")

data <- data %>%
  rename(`Kode PPK` = Kode.PPK,
         `Angka Kontak` = Angka.Kontak,
         `Jumlah Kontak` = Jumlah.Kontak,
         `Jumlah Rujukan` = Jumlah.Rujukan,
         `Kasus Non Spesialistik` = Kasus.Non.Spesialistik,
         `Peserta Diagnosa DM` = Peserta.Diangnosa.DM,
         `Peserta Diagnosa HT` = Peserta.Diangnosa.HT,
         `Peserta Terdaftar` = Peserta.Terdaftar,
         `Prolanis DM Terkendali` = Prolanis.DM.Terkendali,
         `Prolanis HT Terkendali` = Prolanis.HT.Terkendali,
         `RPPT DM` = RPPT.DM,
         `RPPT HT` = RPPT.HT)

#==============================================================================
write.csv(data, "D://data gresik//FactKunjungan//KBK//KBK.csv",
          na="", row.names = FALSE)
#==============================================================================
rekap <- kapitasi %>%
