...
data15 <- read_csv("Sheet 1_Full Data gresik 2015.csv") %>%
  ...
  subset(Nmtkp == "RITL") %>%
  filter(str_detect(Diagnosa,c("I493"))) %>%
  select(-Diagnosa)
...
data <- rbind(data15,data16,data17,data18,data19,data20,data21,data22,data23,
              data24,dataapr24,datamei24)
rm(data15,data16,data17,data18,data19,data20,data21,data22,data23,
   data24,dataapr24,datamei24)
