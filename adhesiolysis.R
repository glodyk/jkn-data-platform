...
data19a <- read_csv("Sheet 1_Full Data gresik 2019.csv") %>%
  select (Nokapst,Nosjp,Jkpst,Umur,Nmtkp,Kdppklayan,
          Nmdati2Layan,Tglpelayanan,Tgldtgsjp,Tglplgsjp,
          Kdinacbgs,Nminacbgs,Kddiagprimer,Nmdiagprimer,
          Diagsekunder,Procedure,Namadpjp,Nmjnspulang,biayars,
          Biayaverifikasi) %>% 
  subset(Nmtkp == "RITL") %>%
  filter(str_detect(Procedure,c("4709 - Other appendectomy; 5459 - Other lysis of peritoneal adhesions")))
...
data19b <- read_csv("Sheet 1_Full Data gresik 2019.csv") %>%
  select (Nokapst,Nosjp,Jkpst,Umur,Nmtkp,Kdppklayan,
          ...
          Biayaverifikasi) %>% 
  subset(Nmtkp == "RITL") %>%
  filter(str_detect(Procedure,c("5459 - Other lysis of peritoneal adhesions; 4709 - Other appendectomy")))
...
data <- rbind(data19a,data19b,data20a,data20b,data21a,
              data21b,data22a,data22b,data23a,data23b,
              data24a,data24b)
rm(data19a,data19b,data20a,data20b,data21a,
   data21b,data22a,data22b,data23a,data23b,
   data24a,data24b)
...
data <- data[order(data$Nmppklayan, data$Tglpelayanan),]
data <- data %>%select(Nokapst,Nosjp,Jkpst,Umur,Nmdati2Layan,
                       Nmppklayan,Tgldtgsjp,Tglplgsjp,LOS,
                       Kdinacbgs,Nminacbgs,Kddiagprimer,
                       Nmdiagprimer,Diagsekunder,Procedure,
                       Namadpjp,Nmjnspulang,biayars,Biayaverifikasi)

#========================================================================
write.xlsx(data, file = "adhesiolysis.xlsx")
#========================================================================
...
df19 <- read_csv("Sheet 1_Full Data gresik 2019.csv") %>%
  select (Nokapst,Nosjp,Jkpst,Umur,Nmtkp,Kdppklayan,
          Nmdati2Layan,Tglpelayanan,Tgldtgsjp,Tglplgsjp,
          Kdinacbgs,Nminacbgs,Kdcmg,Kddiagprimer,Nmdiagprimer,
          Diagsekunder,Procedure,Namadpjp,Nmjnspulang,biayars,
          Biayaverifikasi) %>% 
  subset(Nmtkp == "RITL") %>%
...
df <- rbind(df19,df20,df21,df22,df23,df24)
rm(df19,df20,df21,df22,df23,df24)
...
df <- df %>% subset(Tglpelayanan >= "2019-01-01")


datax <- rbind(data,df)
rm(data,df)

datax <- datax[order(datax$Kdppklayan,
                     datax$Nosjp,
                     datax$Tglplgsjp),]
...
#========================================================================
write.xlsx(data, file = "avshunt ranap.xlsx")
#========================================================================
